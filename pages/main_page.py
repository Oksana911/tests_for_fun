...
class Locators:
    ...
    SORT_BY_ID_BUTTON = (By.XPATH, '//*[@id="root"]/div/section/div/div/button[3]')
...
class MainPage(BasePage):
    ...
    def click_on_the_sort_button(self):
        return self.find_element(Locators.SORT_BY_ID_BUTTON).click()
